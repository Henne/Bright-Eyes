...
@REM BCC.EXE -mlarge -O2 -c SEG001.CPP
@REM BCC.EXE -mlarge -O2 -c SEG002.CPP
@REM BCC.EXE -mlarge -O- -c SEG003.CPP
@REM BCC.EXE -mlarge -O- -c SEG004.CPP
@REM BCC.EXE -mlarge -O- -c SEG005.CPP
@REM BCC.EXE -mlarge -O- -c SEG006.CPP
@REM BCC.EXE -mlarge -O- -c SEG007.CPP
@REM BCC.EXE -mlarge -O2 -c SEG008.CPP
BCC.EXE -mlarge -O2 -c SEG009.CPP
@REM BCC.EXE -mlarge -O- -c SEG010.CPP
@REM BCC.EXE -mlarge -O- -c SEG011.CPP
@REM BCC.EXE -mlarge -O- -c SEG012.CPP
