...
enum {
    ...
    TOWNS_ROVAMUND, TOWNS_NORDVEST, TOWNS_KRAVIK, TOWNS_SKELELLE, TOWNS_MERSKE,
    TOWNS_EFFERDUN, TOWNS_TJOILA, TOWNS_RUKIAN, TOWNS_ANGBODIRTAL, TOWNS_AUPLOG,
    TOWNS_VILNHEIM, TOWNS_BODON, TOWNS_OBERORKEN, TOWNS_PHEXCAER,
    TOWNS_GROENVEL, TOWNS_FELSTEYN, TOWNS_EINSIEDL, TOWNS_ORKANGER,
    TOWNS_CLANEGH, TOWNS_LISKOR, TOWNS_THOSS, TOWNS_TJANSET, TOWNS_ALA,
    TOWNS_ORVIL, TOWNS_OVERTHORN, TOWNS_ROVIK, TOWNS_HJALSING, TOWNS_GUDDASUN,
    TOWNS_KORD, TOWNS_TREBAN, TOWNS_ARYN, TOWNS_RUNINSHA, TOWNS_OTTARJE,
    TOWNS_SKJAL, TOWNS_PREM, TOWNS_DASPOTA, TOWNS_RYBON, TOWNS_LJASDAHL,
    TOWNS_VARNHEIM, TOWNS_VAERMHAG, TOWNS_TYLDON, TOWNS_VIDSAND, TOWNS_BRENDHIL,
    TOWNS_MANRIN, TOWNS_FTJOILA, TOWNS_FANGBODI, TOWNS_HJALLAND, TOWNS_RUNIN
};
