...
| seg001  | CD-Audio Code |
| seg002  | Charactergenerator (mostly everything) |
| seg003  | random number generator |
| seg004  | PP20 decompressor (for compressed images) |
| seg005  | Rasterlib (VGA) |
| seg006  | AIL (Sound) |
