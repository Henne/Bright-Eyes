...
int schick_farcall_v302de(unsigned segm, unsigned offs)
{
	switch (segm) {
		...
		case 0x1377:	return seg059(offs);
		case 0x137b:	return seg060(offs);
		...
		case 0x1408:	return seg087(offs);
		...
		case 0x1429:	return seg093(offs);
		...
		case 0x14cb:	return seg114(offs);
		case 0x14d1:	return seg115(offs);
		case 0x14d8:	return seg116(offs);
		case 0x14e0:	return seg117(offs);
		case 0x14e7:	return seg118(offs);
