...
#define enemy_dead(enemy)	(((struct enemy_sheets*)(enemy))->status.dead)
#define enemy_sleeps(enemy)	(((struct enemy_sheets*)(enemy))->status.sleeps)
#define enemy_stoned(enemy)	(((struct enemy_sheets*)(enemy))->status.stoned)
#define enemy_busy(enemy)	(((struct enemy_sheets*)(enemy))->status.busy)
#define enemy_cursed(enemy)	(((struct enemy_sheets*)(enemy))->status.cursed)
#define enemy_uncon(enemy)	(((struct enemy_sheets*)(enemy))->status.uncon)
#define enemy_illusion(enemy)	(((struct enemy_sheets*)(enemy))->status.illusion)
#define enemy_bit8(enemy)	(((struct enemy_sheets*)(enemy))->status.bit8)
#define enemy_bb(enemy)		(((struct enemy_sheets*)(enemy))->status.bb)
#define enemy_bit11(enemy)	(((struct enemy_sheets*)(enemy))->status.bit11)
