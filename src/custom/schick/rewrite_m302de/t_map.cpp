...
treasure_type t_map(RealPt ptr, const int off)
{
	...
	case 0x13d7: {
		if (f_off == 0x20) return (treasure_type)DNG02_chest00_func3;
		if (f_off == 0x25) return (treasure_type)DNG02_chest01_func3;
		if (f_off == 0x2a) return (treasure_type)DNG02_chest02_func3;
		if (f_off == 0x2f) return (treasure_type)DNG02_chest03_func3;
		if (f_off == 0x34) return (treasure_type)DNG02_chest04_func3;
		if (f_off == 0x39) return (treasure_type)DNG02_chest05_func3;
		if (f_off == 0x3e) return (treasure_type)DNG02_chest06_func1;
		if (f_off == 0x43) return (treasure_type)DNG02_chest06_func3;

		D1_ERR("ERROR: call to seg078:0x%x should not happen\n", f_off);
		exit(-1);
		break;
	}
	case 0x13dd: {
		if (f_off == 0x20) return (treasure_type)DNG03_chest00_func3;
		if (f_off == 0x25) return (treasure_type)DNG03_chest01_func3;
		if (f_off == 0x2a) return (treasure_type)DNG03_chest02_func3;
		if (f_off == 0x2f) return (treasure_type)DNG03_chest03_func3;
		if (f_off == 0x34) return (treasure_type)DNG03_chest04_func3;
		if (f_off == 0x39) return (treasure_type)DNG03_chest05_func3;
		if (f_off == 0x3e) return (treasure_type)DNG03_chest06_func3;
